...
In the chunk below, import ("read in") the data in `a2trees.csv` and call it `a2trees`. Hint: We read in the penguins data in the lab tutorial, so you have similar code in your lab notes document.
...
## Question 3
Use a function to see what the `a2trees` data look like. Then, list out the categorical and quantitative variables.
...
List the categorical variables in the data set:
*replace this text with your list of categorical variables*

There are no quantitative variables in the data set. Feel free to ask us why the variables that *look like* quantitative variables are not actually quantitative variables.
...
2. Click More > Export... </br>
  ...
  ![Click the More menu, then Export](assets/images/pdf_export.png)
